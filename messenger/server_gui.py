...
# Создание таблицы QModel, будет отображаться в окне программы.
def gui_create_model(database):
    ...
    for row in list_users:
        ...
        list_create_model.appendRow([user, ip, port, time])
    return list_create_model


# Функция заполняет таблицу историей сообщений из БД.
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Кнопка для обновления списока клиентов
        ...
        # Настройки формы и размера основного окна.
